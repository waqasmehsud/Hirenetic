...
- **Environment variables:** set per Vercel Environment (Development/Preview/Production) matching the categories in §3. Preview environment variables point at the Supabase *staging* project; Production environment variables point at the Supabase *production* project.
